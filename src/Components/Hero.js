        ...
        <div className="flex flex-col sm:flex-row mt-10">
          <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
            ...
            <div className="flex flex-col items-center text-center justify-center">
              ...
              <p className="text-base">Lider de Equipo</p>
            </div>
          </div>
    ...
    <div class="container px-5 py-24 mx-auto flex flex-wrap">
      ...
      <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
        ...
        <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
          ...
          <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
            <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Almacenamiento de Datos</h2>
            <p class="leading-relaxed"> Nuestra infraestructura de almacenamiento de datos utiliza las últimas tecnologías de seguridad para proteger su información contra amenazas cibernéticas y garantizar su integridad a lo largo del tiempo. Además, cumplimos rigurosamente con las regulaciones de privacidad y protección de datos, lo que significa que puede confiar en que sus datos estarán en buenas manos.</p>
          </div>
        </div>
      </div>
      <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
        ...
        <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
          ...
          <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
            <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Registro de Usuarios</h2>
            <p class="leading-relaxed">Nuestro sistema de registro de usuarios se destaca por su facilidad de uso y flexibilidad. Con una interfaz intuitiva, podrás registrar y mantener la información de todos los usuarios de tu institución de manera eficiente.</p>
          </div>
        </div>
      </div>
    </div>

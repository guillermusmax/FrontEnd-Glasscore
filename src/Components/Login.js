  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
    ...
    <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
      ...
      <div class="relative mb-4">
        ...
        <input type="text" id="full-user" user="full-user" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
      </div>
      <div class="relative mb-4">
      ...
      <Link href="/forget">
                    <button classuser="text-indigo-500 inline-flex items-center">Forget Password?
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" classuser="w-4 h-4 ml-2" viewBox="0 0 24 24"></svg>
                    </button>
                </Link>
    </div>
  </div>
